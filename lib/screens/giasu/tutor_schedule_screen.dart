    ...
    return Scaffold(
      ...
      body: BlocConsumer<LichHocBloc, LichHocState>(
        listener: (context, state) {
          ...
          if (state is LichHocUpdated || state is LichHocDeleted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Header: Trạng thái + Badge Online/Offline
                  Row(
                    children: [
                  ...
                  // --- PHẦN HIỂN THỊ ĐỊA CHỈ (Logic mới) ---
                  if (!isOnline) ...[
                    const SizedBox(height: 6),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            diaChi, // Biến địa chỉ lấy ở trên
                            style: TextStyle(
                              fontSize: 13,
                              color: Colors.grey.shade700,
                              height: 1.3,
                  ...
                  Row(
                    children: [
                      ...
                      // Nút Cập nhật (Chỉ hiện khi chưa hoàn thành/hủy)
                      ...
                      // Nút Vào dạy (Chỉ hiện nếu có Link)
                      if (hasLink) ...[
                        const SizedBox(width: 8),
                        Expanded(
