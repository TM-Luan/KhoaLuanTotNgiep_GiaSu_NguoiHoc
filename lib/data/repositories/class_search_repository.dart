...
class ClassSearchRepository {
  // Sử dụng ApiConfig.baseUrl thay vì hardcode
  static String get baseUrl => ApiConfig.baseUrl;

  Future<ApiResponse<List<LopHoc>>> searchClasses({
    String? query,
    ClassFilter? filter,
    int page = 1,
    int perPage = 10,
    ...
    try {
      final uri = Uri.parse('$baseUrl/lophoc/search');
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          final List<LopHoc> classes = classesJson
              .map((json) => LopHoc.fromJson(json))
              .toList();
          return ApiResponse(
            success: true,
            message: 'Thành công',
